  ...
  releaseConsole: {
    packages: [
      ...
      },
      {
        ...
        approvals: ['Creative Lead', 'Web Ops'],
    ...
    watchers: [
      { id: 'qa-core', name: 'QA Core', channel: 'Slack #qa-ops' },
      { id: 'release', name: 'Release Management', channel: 'Email release@intent.games' },
      { id: 'marketing', name: 'Marketing Sync', channel: 'Slack #release-alerts' },
    ],
    notifications: [
      {
        id: 'notif-staging',
