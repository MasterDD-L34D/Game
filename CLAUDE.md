...
> **Current sprint** (v47, 2026-06-08 -- reconstruction suite + roadmap SPEC-A..L device/TV): resume = _"leggi `docs/planning/2026-06-06-evo-tactics-reconstruction-suite-index.md` (ingresso unico della suite) + entrypoint `docs/planning/2026-06-05-evo-tactics-open-points-resolution-roadmap.md` (baseline ratificata + roadmap SPEC-A..L con build-order). Direzione = device-driven / TV-mirror / event-log identity. Stato 2026-06-08: suite design-spec SPEC-A..L TUTTE su main (`doc_status: review_needed`) -- A/B/C/D/E/F/G/J/K/L + backend Gate-5 (#2618 ledger, #2622 /declare-reaction, #2623 /preview-round); 34 fork ratificati da Eduardo (PRs #2616-#2629). Principio trasversale = opt-in self-disclosure. Handoff: `docs/planning/2026-06-08-reconstruction-suite-wave1-closure.md`. Residuo: SPEC-H (ALIENA enforcement/lore) + SPEC-I (ERMES runtime pressure) + flip review_needed->accepted + implementazione Godot."_
