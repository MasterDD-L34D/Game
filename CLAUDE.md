...
> **Current sprint** (v49, 2026-06-08 -- reconstruction suite SPEC-A..Q device/TV + narrative-depth): resume = _"leggi `docs/planning/2026-06-06-evo-tactics-reconstruction-suite-index.md` (ingresso unico) + entrypoint `docs/planning/2026-06-05-evo-tactics-open-points-resolution-roadmap.md` (baseline ratificata + roadmap SPEC-A..Q; sez. 3bis gap-extensions, 3ter game-reference DF-levels). Direzione = device-driven / TV-mirror / event-log identity + DF-levels narrative depth. Stato 2026-06-08: suite design-spec SPEC-A..Q TUTTE su main (`doc_status: review_needed`) -- A/B/C/D/E/F/G/H/I/J/K/L + gap-harvest M(Onboarding)/N(Localization)/O(Mission Templates)/P(Failure-as-lore) + Q(DF-levels narrative depth #2645). **Spec-piena (full contract + ARCHON harsh-review + fork ratificati): H/I/J + M/O/P/Q** (#2638-2645); N resta scope-doc. Backend Gate-5 (#2618 ledger, #2622 /declare-reaction, #2623 /preview-round) + SPEC-M per-player onboarding model #2638 + SPEC-O sabotage/escape templates #2640. Drift-audit settimanale #2624. Principio trasversale = opt-in self-disclosure. Residuo: flip review_needed->accepted (Eduardo) + implementazione (chronicle/identity/A13/FP-VC/runner) + SPEC-N spec-piena + MA1 ADR-supersede 51-ONBOARDING. Handoff: `docs/planning/2026-06-08-reconstruction-suite-wave1-closure.md`."_
