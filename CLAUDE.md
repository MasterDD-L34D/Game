...
> **Current sprint** (v48, 2026-06-08 -- reconstruction suite SPEC-A..P device/TV): resume = _"leggi `docs/planning/2026-06-06-evo-tactics-reconstruction-suite-index.md` (ingresso unico della suite) + entrypoint `docs/planning/2026-06-05-evo-tactics-open-points-resolution-roadmap.md` (baseline ratificata + roadmap SPEC-A..P con build-order; sez. 3bis = gap-extensions harvest + Wave-4). Direzione = device-driven / TV-mirror / event-log identity. Stato 2026-06-08: suite design-spec SPEC-A..P TUTTE su main (`doc_status: review_needed`) -- A/B/C/D/E/F/G/H/I/J/K/L + gap-harvest M(Onboarding)/N(Localization)/O(Mission Templates)/P(Failure-as-lore) (#2633) + backend Gate-5 (#2618 ledger, #2622 /declare-reaction, #2623 /preview-round). Wave-2 H (ALIENA enforcement/lore #2631) + I (ERMES runtime pressure #2632) MERGED, fork HA/ER ratificati. Drift-audit settimanale #2624. Principio trasversale = opt-in self-disclosure. Handoff: `docs/planning/2026-06-08-reconstruction-suite-wave1-closure.md`. Residuo: flip review_needed->accepted (Eduardo, al merge) + implementazione Godot."_
