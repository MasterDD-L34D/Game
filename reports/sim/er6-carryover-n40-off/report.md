...
| economy_flow | drift 1.095 (pe 49.4, bp 181.8) | 0.5 - 2 | ✅ |
| relationship_progress | recruit 5.55, aff 1, mate 4.675 | composite | ✅ |
| offspring_viability | offspring 4.675 | >= 1 | ✅ |
| lineage_diversity | 5 crosses, dominant dune-stalker x nano-rust-bloom | >= 3 | ✅ |
| roster_composition | dominant APEX/HAZARD, 5 roles | >= 3 | ✅ |

> Note (economy_flow): PE earned + build-power drift; PI sink exercised (472 attempts)

## Personality axes (Opt 3 OUTPUT) -- N-sample evidence

2401 per-unit samples. Constants are PROPOSED (blend weights + stat bounds, #2679): this section is EVIDENCE for the N=40 ratification batch (incl. the J_P + formPulseVc E_I flags); master-dd ratifies, the batch never does.

| axis | n | mean | sd | min | max | neutral_rate |
| --- | --- | --- | --- | --- | --- | --- |
| symbiosis_predation | 2401 | 0.991 | 0.042 | 0.688 | 1.000 | 0.000 |
| explore_caution | 2401 | 0.626 | 0.205 | 0.500 | 1.000 | 0.720 |
| solitary_swarm | 2401 | 0.578 | 0.206 | 0.250 | 1.000 | 0.768 |
| memory_instinct | 2401 | 0.505 | 0.049 | 0.430 | 0.875 | 0.887 |
| agile_robust | 2401 | 0.478 | 0.076 | 0.140 | 0.735 | 0.663 |

Degenerate (all-5 neutral) rate: 0.000.
Dominant-axis histogram: symbiosis_predation 2182, solitary_swarm 219.
Collinearity (|r| >= 0.8): symbiosis_predation~memory_instinct r=-0.89.
Faction player (808): symbiosis_predation 1.00, explore_caution 0.63, solitary_swarm 0.62, memory_instinct 0.50, agile_robust 0.44.
Faction sistema (1593): symbiosis_predation 0.99, explore_caution 0.62, solitary_swarm 0.56, memory_instinct 0.51, agile_robust 0.50.
