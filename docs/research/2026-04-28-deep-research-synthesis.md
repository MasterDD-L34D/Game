...
| P5 Co-op      | 🟡→🟢 post TKT-M11B-06                                                            | Battle Brothers ambitions + world-crises                                   | Long-arc campaign goal missing → "combat isolated" risk                      | Single ambition wire QBN ~3-5h post-playtest trigger               |
