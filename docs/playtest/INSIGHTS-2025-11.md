...
- **Progressione XP Helix/Cipher**: il tuning 12/11 (completion bonus 285, modifier Helix 1.035/Cipher 0.965) allinea il profilo combinato Helix+Cipher a un delta -0.0009% sul target Standard e riduce lo scostamento singolo a ±3.5%.【F:data/derived/analysis/progression/skydock_siege_xp.json†L96-L152】【F:data/derived/analysis/progression/skydock_siege_xp_profiles.csv†L1-L4】
...
- **XP delta Helix+Cipher**: la telemetria `pilot-2025-11-12` registra un delta -0.0009% sul target Standard e margine <0.21% sugli altri tier, confermando la stabilizzazione della sinergia supporto.【F:logs/pilot-2025-11-12/telemetry/skydock_siege_xp_delta.json†L1-L43】
