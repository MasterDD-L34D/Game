...
| 5   | **Mission Console / HUD / XP Cipher**              | Bundle Vue3 frozen in `docs/mission-console/` (funzionale, deployato). No source nel repo. ADR superseded. `apps/dashboard/` scaffold rimosso (#1343).                                      | **promuovere a core**     | Linkare da GDD Master §10 (boundary HUD/Console/telemetry). Documentare pipeline rebuild esterna. XP Cipher non trovato — rimuovere riferimento o chiarire.              | `docs/core/30-UI_TV_IDENTITA.md`, `docs/core/17-SCREEN_FLOW.md`, `docs/mission-console/index.html`, `docs/adr/ADR-2026-04-14-dashboard-scaffold-vs-mission-console.md` |
