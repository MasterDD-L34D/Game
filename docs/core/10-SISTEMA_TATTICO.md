...
- **MoS (Margin of Success)**: ogni +5 sulla DC = +1 step danno; a 5/10 guadagni PP bonus. **Cap step = 6** (fairness canonico post damage modifier, vedi `docs/hubs/combat.md` `DAMAGE_STEP_CAP=6`; la vecchia SoT sez.13.2 e' storica, history git).
