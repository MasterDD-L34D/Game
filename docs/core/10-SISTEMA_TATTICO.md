...
- **MoS (Margin of Success)**: ogni +5 sulla DC = +1 step danno; a 5/10 guadagni PP bonus. **Cap step = 6** (fairness canonico post damage modifier, vedi `00-SOURCE-OF-TRUTH.md §13.2` + `docs/hubs/combat.md` `DAMAGE_STEP_CAP=6`).
