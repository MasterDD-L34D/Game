---
title: Tutorial rapido · Overlay HUD Smart Alerts (canary)
doc_status: active
...
- [ ] Canvas aggiornato nella sezione [Sync HUD · dicembre 2025](../frontend/feature-updates.md#sync-hud--dicembre-2025).
