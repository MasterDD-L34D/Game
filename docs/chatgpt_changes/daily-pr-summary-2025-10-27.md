...
| [#161](https://github.com/MasterDD-L34D/Game/pull/161) | Persist renderer used in visual regression baselines | @MasterDD-L34D | 2025-10-27T03:29:51Z |
...
| [#200](https://github.com/MasterDD-L34D/Game/pull/200) | Align Evo-Tactics cross events with available network edges | @MasterDD-L34D | 2025-10-27T12:31:45Z |
...
> ## Summary
> - record the latest run of `scripts/run_deploy_checks.sh` in `logs/web_status.md`
> - update the milestone checklist with the completed web bundle validation and remaining follow-ups
> ## Testing
> - scripts/run_deploy_checks.sh
> ------
> https://chatgpt.com/codex/tasks/task_e_68fed00f5c70833285510564ebc2dc81

## #139 — Update CLI rollout docs for Nov 2025 onboarding

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T01:58:19Z
- Link: https://github.com/MasterDD-L34D/Game/pull/139

> ## Summary
> - refresh the post-October 2025 process docs with CLI validation steps and logging checkpoints
> - add the follow-up ADR describing the CLI rollout and onboarding expectations
> - expand onboarding materials, FAQ coverage, and provide a CLI bug escalation template
> ## Testing
> - not run (documentation changes only)
> ------
> https://chatgpt.com/codex/tasks/task_e_68fed05ad6d883328878df2668fe06d7

## #140 — Annota nuovo clone e percorso condiviso in checklist setup

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T02:05:12Z
- Link: https://github.com/MasterDD-L34D/Game/pull/140

> ## Summary
> - update the project setup checklist with the latest clone date and environment details
> - record the shared Drive folder used for future reconfigurations alongside the local path
> ## Testing
> - not run
> ------
> https://chatgpt.com/codex/tasks/task_e_68fed1c26c7c833296e40e5ac1ffd631

## #142 — refactor: ship showcase exports as text assets

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T02:31:12Z
- Link: https://github.com/MasterDD-L34D/Game/pull/142

> ## Summary
> - replace the committed WebP/PDF showcase assets with a text-based SVG preview and a Base64 dossier export
> - update the showcase builder to emit the SVG hero, persist the PDF as Base64, and refresh the README/checklist/demo script accordingly
> ## Testing
> - python tools/py/build_showcase_materials.py
> ------
> https://chatgpt.com/codex/tasks/task_e_68fed124eacc833292417291c9e3d247

## #143 — Document blocked BAL-03 validation attempt
...
> ## Summary
> - remove the EVT-01 before/after PNG captures that prevented PR creation
> - update the playtest media README to point to the NAS location for the assets
> ## Testing
> - not run (documentation update)
> ------
> https://chatgpt.com/codex/tasks/task_e_68feda1537b083329fdbf50346f95222

## #149 — Document bug triage scales and intake checklist

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T03:08:47Z
- Link: https://github.com/MasterDD-L34D/Game/pull/149
...
## #150 — Document web pipeline review workflow

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T03:11:50Z
- Link: https://github.com/MasterDD-L34D/Game/pull/150

> ## Summary
> - extend the traits checklist with a dedicated web pipeline section covering CI/manual triggers, promotion gates, and a status area
> - add a scheduled review log for weekly web status tracking with actionable reminders
> - provide an automation script that updates the checklist status block and appends summarized results to the web status log
> ## Testing
> - not run
> ------
> https://chatgpt.com/codex/tasks/task_e_68fee1a666548332b247997c619f5b49

## #151 — Document roadmap-linked triage cadence

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T03:17:24Z
- Link: https://github.com/MasterDD-L34D/Game/pull/151
...
## #152 — Address Codex review feedback for playtest documentation
...
- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T03:23:36Z
- Link: https://github.com/MasterDD-L34D/Game/pull/155
...
## #156 — Fix PI balance alert channel for risk HUD

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T03:24:03Z
- Link: https://github.com/MasterDD-L34D/Game/pull/156
...
## #157 — Reset unavailable composer roles in composer panel

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T03:25:42Z
- Link: https://github.com/MasterDD-L34D/Game/pull/157
...
## #158 — Add archive assets for 26 Feb 2025 playtest follow-up

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T03:25:54Z
- Link: https://github.com/MasterDD-L34D/Game/pull/158
...
## #159 — Fix duplicate MANIFEST_PRESETS declaration in generator
...
## #162 — feat: extend drive sync to hub ops datasets
...
## #165 — Fix PI balance alert channel for risk HUD
...
## #171 — Fix generator controls and add quickstart guide
...
## #176 — Add SquadSync analytics pipeline and UI
...
## #183 — Add production dataset snapshot and document deploy check failure
...
## #187 — Create trait inventory and tracking checklist
...
## #189 — Add EVT-02 narrative session plan and tracking
...
## #192 — Document RC release prep and add HUD asset
...
## #196 — Add ADR for CLI refactor motivations
...
## #200 — Align Evo-Tactics cross events with available network edges
...
## #203 — Stop forcing legacy Playwright mirror in deploy checks
...
## #202 — Ensure deploy workflow installs Python deps before CLI gates
...
## #212 — Allow deploy workflow to validate pull requests without publishing

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T19:22:36Z
- Link: https://github.com/MasterDD-L34D/Game/pull/212

> ## Summary
> - run the deploy workflow for pull requests so the required status is reported
> - skip the GitHub Pages publish steps for non-push events while still running validation
> - force CI mode when running deploy validation checks to ensure Playwright shuts down cleanly
> ## Testing
> - not run (CI-only workflow change)
> ------
> https://chatgpt.com/codex/tasks/task_e_68ffb869ee708332b8c7e9b7d51feff2

## #213 — Fix HUD canary workflow Python heredoc syntax

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T19:39:37Z
- Link: https://github.com/MasterDD-L34D/Game/pull/213
...
## #214 — Improve workflow flag parsing and deploy build

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-27T19:56:17Z
- Link: https://github.com/MasterDD-L34D/Game/pull/214
...
## #215 — Allow deploy workflow to run outside push events
