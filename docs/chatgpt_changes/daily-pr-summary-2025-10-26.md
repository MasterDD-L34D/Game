...
| [#106](https://github.com/MasterDD-L34D/Game/pull/106) | Align PI balance alert notifications with configured channel | @MasterDD-L34D | 2025-10-26T20:25:14Z |
...
## #72 — Restore CI workflow and expand site deployment
...
## #75 — Populate ext v1.5 NPG pack and add validation docs
...
## #82 — Add radar comparison UI to ecosystem generator
...
## #91 — Add playtest documentation for scenarios and pilot session
...
## #94 — Document post-October 2025 processes and CLI ADR
...
> ## Summary
> - add manifest preset configuration and UI to drive export bundles and inline checklists
> - generate dossier HTML/PDF using a reusable template and expose previews inside the generator
> - implement multi-file ZIP export plus refreshed styling for the new export panel
> ## Testing
> - not run (not requested)
> ------
> https://chatgpt.com/codex/tasks/task_e_68fe78e329648332a5ef9ee74c1518c1

## #101 — Implement HUD risk alert instrumentation and Skydock Siege retune

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-26T19:56:38Z
- Link: https://github.com/MasterDD-L34D/Game/pull/101

> ## Summary
> - add a reusable risk HUD alert middleware with telemetry recording and unit tests
> - retune Skydock Siege timers/cooldowns based on new time_low_hp trends and tilt targets
> - log the November 5 VC playtest results and update roadmap/checklists with the validation details
> ## Testing
> - npm test
> ------
> https://chatgpt.com/codex/tasks/task_e_68fe7a79c0d083329802e64705d5091e

## #103 — Fix manifest preset initialization order

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-26T20:04:14Z
- Link: https://github.com/MasterDD-L34D/Game/pull/103

> ## Summary
> - move manifest preset definitions before generator state initialization
> - ensure export preset selection reads from defined constant during module load
> ## Testing
> - not run (not requested)
> ------
> https://chatgpt.com/codex/tasks/task_e_68fe78e329648332a5ef9ee74c1518c1

## #104 — Implement HUD risk alert instrumentation and Skydock Siege retune

- Autore: @MasterDD-L34D
- Label: codex
- Merged: 2025-10-26T20:22:14Z
- Link: https://github.com/MasterDD-L34D/Game/pull/104

> ## Summary
> - add a reusable risk HUD alert middleware with telemetry recording, per-mission state handling, and unit tests
> - retune Skydock Siege timers/cooldowns based on new time_low_hp trends and tilt targets
> - log the November 5 VC playtest results and update roadmap/checklists with the validation details
> ## Testing
...
## #102 — Automate daily PR reporting
...
## #108 — Add filter profiles, history, and lock persistence to ecosystem generator
...
## #110 — Add narrative prompt generation and rare event feedback to generator
...
## #114 — Replace balancing workbook with CSV export
...
## #120 — Restore original manifest presets alongside demo bundle
...
## #125 — Align PI traits with environment registry
...
## #127 — Add advanced composition panel with synergy tooling
