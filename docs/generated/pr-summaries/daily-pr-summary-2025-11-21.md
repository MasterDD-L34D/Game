...
> ## Testing
>
> - npm test --workspace apps/dashboard _(fails: missing ../../src/config/dataSources.ts and existing analytics expectations)_
> - PRISMA*ENGINES_CHECKSUM_IGNORE_MISSING=1 npx prisma generate --schema apps/backend/prisma/schema.prisma *(fails: Prisma engine download blocked by 403)\_
>
> ---
>
> Codex Task (riferimento interno)
