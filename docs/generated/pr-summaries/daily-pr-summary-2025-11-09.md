...
> - cover the new access rules with tests and document the required AUTH\_\* environment variables
>
> ## Testing
>
> - node --test tests/api/traits.validate.test.js _(fails: Cannot find module 'supertest' – dev dependency not available in environment)_
> - node --test tests/api/traits.auth.test.js _(fails: Cannot find module 'supertest' – dev dependency not available in environment)_
>
> ---
>
> Codex Task (riferimento interno)
...
> - npx html-validate docs/index.html docs/ideas/index.html _(fails: npm 403 – registry not reachable in the execution environment)_
>
> ---
>
> Codex Task (riferimento interno)
