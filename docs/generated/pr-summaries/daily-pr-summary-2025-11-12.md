...
> - python tools/audit/data*health.py *(fails: Missing file packs/evo*tactics_pack/data/core/species.yaml)*
>
> ---
>
...
> - node scripts/update_evo_pack_catalog.js
> - node scripts/sync_evo_pack_assets.js
> - python tools/audit/data*health.py *(fails: packs/evo*tactics_pack/data/core/species.yaml missing in repository)*
>
> ---
>
> Codex Task (riferimento interno)
