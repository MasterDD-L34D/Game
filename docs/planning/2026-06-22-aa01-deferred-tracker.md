...
| D6  | **C2-imprint axis->trait grant**                  | Make the 4 axes grant mechanical traits (aa01 V2 dropped V1's choice->trait_id)                                     | **RATIFIED + BUILT flag-OFF 2026-06-30** (stacking B + designated-axis locomotion; `IMPRINT_TRAIT_GRANT_ENABLED` OFF; mapping PROPOSED -> N=40 flip) -> [spec](2026-06-23-aa01-imprint-axis-trait-grant-spec-draft.md) sec.0 | aa01                                                                                                          |
