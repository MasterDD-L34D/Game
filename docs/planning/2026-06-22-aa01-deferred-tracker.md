...
| D6  | **C2-imprint axis->trait grant**                  | Make the 4 axes grant mechanical traits (aa01 V2 dropped V1's choice->trait_id)                                     | **RATIFIED + BUILT flag-OFF 2026-06-30** (#3083 stacking B + designated-axis locomotion). **SUPERSEDED 2026-06-30** by the form-pulse v2 flip-readiness build (W2/W3/W4): the unified `brancoTraitProducer` now reads ALL 4 imprint axes (verdict D-2) + `IMPRINT_TRAIT_GRANT_ENABLED` collapsed into `FORM_PULSE_TRAIT_V2_ENABLED` (W4). Mapping = 6/8 wired LIVE-audited (2 balance-pick UNWIRED) -> N=40 flip. See [build-spec](2026-06-30-form-pulse-trait-v2-flip-readiness-build-spec.md) W2-W4 | aa01                                                                                                          |
| D7  | **C2-imprint diegetic prose + hint-string**       | Player-facing copy + "il tuo branco tende verso X" wording                                                          | **SCAFFOLD BUILT 2026-06-30** ([#3084](https://github.com/MasterDD-L34D/Game/pull/3084) `3ad66130`): `brancoTendencyHint` structure (i18n_key + vars) on the hint; PROSE still master-dd HITL (client i18n)                                                                                                                                                                                                                                                                                           | aa01                                                                                                          |
| D8  | **CAP-07 chain-lightning propagation**            | `chainElectrified` multi-tile BFS over the persistent `tile_state_map` on an electrified tile                       | **BUILT flag-OFF 2026-06-30** ([#3082](https://github.com/MasterDD-L34D/Game/pull/3082) `b138a7dd`): `chainLightningStrike` wired behind `TERRAIN_CHAIN_LIGHTNING_ENABLED`; PROPOSED radius 2 / shock 2 -> N=40 flip                                                                                                                                                                                                                                                                                  | terrain reactions (M14-A legacy), NOT a SPEC letter                                                           |
