...
| `.github/workflows/incoming-smoke.yml`        | dev-tooling      | Log assente – dispatch manuale pianificato (2025-12-02)                                       | enforcing                     | Trigger manuale previsto post-ripristino host per validare incoming; log attesi in `logs/incoming_smoke`.                                           |
