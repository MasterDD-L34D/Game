...
| --------------------------------------------- | ---------------- | --------------------------------------------------------------------------------------------- | ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `.github/workflows/ci.yml`                    | dev-tooling      | Log assente – eseguire run completo                                                           | enforcing                     | Richiesto run completo pre-go-live; verificare suite dashboard/CLI.                                                                                 |
| `.github/workflows/e2e.yml`                   | QA               | Log assente – eseguire run Playwright                                                         | enforcing                     | Nessun log locale; eseguire Playwright contro env target.                                                                                           |
...
| `.github/workflows/deploy-test-interface.yml` | devops           | Log assente – pianificare dry-run Pages                                                       | enforcing                     | Nessun log locale; necessario dry-run Pages con bundle HUD/CLI.                                                                                     |
...
| `.github/workflows/incoming-smoke.yml`        | dev-tooling      | Log assente – trigger manuale richiesto                                                       | enforcing                     | Log attesi in `logs/incoming_smoke`; rieseguire per nuovi incoming.                                                                                 |
...
| `.github/workflows/qa-export.yml`             | QA               | Log assente – trigger manuale necessario                                                      | enforcing                     | Manuale; raccogliere artefatti QA prima del merge.                                                                                                  |
| `.github/workflows/qa-reports.yml`            | QA               | Log assente – run PR/manuale richiesto                                                        | enforcing                     | Richiesto run PR/manuale per aggiornare `reports/qa_badges.json`/baseline.                                                                          |
...
| `.github/workflows/hud.yml`                   | HUD              | Log assente – abilitare flag HUD e build                                                      | enforcing (salta se flag off) | Necessario run HUD overlay; verificare `config/cli/hud.yaml` abilitato.                                                                             |
