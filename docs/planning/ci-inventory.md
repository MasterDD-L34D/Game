...
| `.github/workflows/validate-naming.yml`       | data             | 2025-12-03 – PASS 【F:logs/ci_runs/validate-naming_run4.log†L1-L1】                                  | enforcing                     | KO glossario chiuso: rerun naming verde con `ali_solari_fotoni` presente nel reference e nel glossario.                          |
