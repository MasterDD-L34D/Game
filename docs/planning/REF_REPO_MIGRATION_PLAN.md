...
| Readiness 01B/01C ([nota readiness](#nota-readiness-01b01c-2025-12-07)) | species-curator (lead 01B), trait-curator, balancer, archivist, coordinator | Dopo gap list approvata | Kickoff compressi loggati `[01B-KICKOFF-2025-12-07T1500Z]` / `[01C-HANDOFF-2025-12-07T1515Z]` in [logs/agent_activity.md](../../logs/agent_activity.md); branch attivi `patch/01B-core-derived-matrix` e `patch/01C-tooling-ci-catalog` in modalità report-only con freeze documentale 2025-11-29T09:00Z→2025-12-07T18:00Z chiuso. Ticket **[TKT-01B-001]**/**[TKT-01B-002]** e **[TKT-01C-001]**/**[TKT-01C-002]** riallineati ai README incoming e `REF_INCOMING_CATALOG`; readiness rerun 02A invariata. |
...
<a id="nota-readiness-01b01c-2025-12-07"></a>

### Nota readiness 01B/01C (agg. 2025-12-07)

- **On-call 01B (core/derived):** species-curator (lead), trait-curator (nomenclature/trait mapping), balancer (priorità P0/P1/P2), archivist (cross-check catalogo 01A), coordinator (gate/log). Kickoff in modalità report-only riaperto e loggato `[01B-KICKOFF-2025-12-07T1500Z]` in [logs/agent_activity.md](../../logs/agent_activity.md) con branch `patch/01B-core-derived-matrix` attivo, freeze documentale 2025-11-29T09:00Z→2025-12-07T18:00Z chiuso e ticket **[TKT-01B-001]**/**[TKT-01B-002]** riallineati a `incoming/README.md` e `docs/planning/REF_INCOMING_CATALOG.md`.
- **On-call 01C (tooling/CI):** dev-tooling (lead) con coordinator per priorità; readiness e handoff loggati `[01C-HANDOFF-2025-12-07T1515Z]` in [logs/agent_activity.md](../../logs/agent_activity.md), branch `patch/01C-tooling-ci-catalog` attivo in **report-only** per inventario CI/tooling; nessun rollout esecutivo finché 01A–01B non sono chiusi.
- **Freeze e ticket attivi:** finestra documentale 2025-11-29T09:00Z → 2025-12-07T18:00Z chiusa (log `[01B-KICKOFF-2025-12-07T1500Z]` / `[01C-HANDOFF-2025-12-07T1515Z]`); ticket **[TKT-01B-001]**, **[TKT-01B-002]**, **[TKT-01C-001]**, **[TKT-01C-002]** tracciati in STRICT MODE con riferimenti incrociati su README incoming e `REF_INCOMING_CATALOG`.
- **Rischi aperti:** freeze da riattivare se arrivano nuovi drop post-07/12; mantenere allineati log 02A/03A/03B per evitare drift tra runbook e branch e replicare gli ID ticket in tutti i reference collegati.
