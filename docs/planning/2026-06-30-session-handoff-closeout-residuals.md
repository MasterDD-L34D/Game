...
- **Tier-2 remaining**: O3 PILLAR re-verify VALUES 6/6 (master-dd action); **aa01 cluster** O4 D6 axis->trait grant (banda) / O5 D7 prose hint-string (HITL) / O6 D8 chain-lightning propagation (balance).
...
- **Infra forbidden-path** (master-dd merge/hands): I2 ci.yml stale refs / I3 crossbreed cooldown (contracts) / I4 SPEC-E ritual cost / I8 prod-flips bundle.
