...
| ~~**ER6 overrun carry-over fork**~~ (TKT-ER6-CARRYOVER)            | SPEC-I                    | ✅ **BUILT flag-OFF + N=40 band-SAFE (grilling 2026-06-30, PR #3119)** -- master-dd scelse carry-over (vs consume-once); flag OFF, banda PROVISIONAL (W5). Codex P2 fixato (drop-carry su pool-exhausted). OWNER-merge                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | DONE-build (OWNER-merge)                                            |
