...
| **GAP2 inert-trait mechanics**                     | trait-mechanics | 🟡 06-29: **12 wired** -- block-2 #3044 `6d8dd9cb` + block-3 #3068 `102ae13e` (inert traits go live). Residuo GAP2-next = 45 boilerplate (rewrite-first) / 9 `*_2` (#3036) / cluster buff-mobility-recon, design-gated                                                                                                                                   |
