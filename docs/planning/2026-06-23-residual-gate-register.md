...
| **SPEC-F durable crossbreed cooldown**                   | SPEC-F          | **PR #3101 PREPARED 2026-06-30** -- `campaign_id` schema field + cooldown da history persistente (no piu' in-memory Set); FIFO-edge `TKT-SKIV-COOLDOWN-FIFO`. forbidden-path -> master-dd merge pending                                                                                                                     |
