...
| **GAP2 inert-trait mechanics**                     | trait-mechanics | 🟡 06-30: **12 wired** -- block-2 #3044 `6d8dd9cb` + block-3 #3068 `102ae13e` + 9 `*_2` #3074 (inert traits go live). Residuo GAP2-next = **DEFERRED master-dd 06-30**: 39 boilerplate (rewrite-first, prosa design) / cluster buff-mobility-recon (primitive engine forbidden-path); inert recount 91->76                                               |
