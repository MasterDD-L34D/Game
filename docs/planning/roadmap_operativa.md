...
1. **Smart HUD & SquadSync** _(priorità alta)_
   ...
   - **Follow-up 2025-11-07:** overlay HUD telemetrico (Owner: UI Systems — F. Conti), contrasto EVT-03 (Owner: VFX/Lighting — G. Leone) tracciati in checklist/milestones e tool run report; contrasto EVT-03 chiuso il 2025-11-08 con gamma dinamico + toggle glow (vedi log smoke test). XP Cipher (ex PROG-04) **parked** via [ADR-2026-04-17](../adr/ADR-2026-04-17-xp-cipher-official-park.md).【F:docs/chatgpt_changes/daily-pr-summary-2025-11-07.md†L1-L15】【F:docs/checklist/milestones.md†L13-L18】【F:docs/tool_run_report.md†L23-L31】【F:logs/playtests/2025-11-08-vfx/contrast-smoke.yaml†L1-L35】
