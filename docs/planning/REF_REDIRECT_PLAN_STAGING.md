...
| Rollback (se necessario)     | Master DD + Dev-tooling | Ready/Approved | Ticket Master DD [#1206](https://github.com/MasterDD-L34D/Game/issues/1206) consolidato **Ready/Approved**: baseline di rollback su smoke `[REDIR-SMOKE-2025-12-08T1100Z]` (**PASS**, host ripristinato) con conferma successiva da `[ROLLBACK-SIM-2026-09-07T1200Z]` e smoke post-restore **PASS** (`reports/redirects/redirect-smoke-staging.json` log `[REDIR-SMOKE-2026-09-08T1200Z]`). Gate di rollback pronto con finestra alternativa 2025-12-09T09:00Z→18:00Z disponibile. |
