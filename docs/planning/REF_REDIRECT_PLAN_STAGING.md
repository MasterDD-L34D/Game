...
Stato: **Ready/Approved** per mapping/smoke (ultimo smoke `[REDIR-SMOKE-2026-09-08T1200Z]` **PASS** su host `http://localhost:8000`, report [reports/redirects/redirect-smoke-staging.json](../../reports/redirects/redirect-smoke-staging.json) allegato ai ticket #1204/#1205); lato backup/rollback **policy archive-less attiva**: tar/zip dismessi, verifiche basate su resoconti/testo (hash e smoke) con ticket #1203/#1206 da aggiornare. Mapping TKT-03B-001 allineato alla milestone 07/12/2025 con report/log allegati; freeze 03AB chiuso con firma Master DD e manifest archiviati.
...
| ----------------------------------------------------------------------------------------- | -------------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [#1204](https://github.com/MasterDD-L34D/Game/issues/1204) – Ok a finestra di attivazione | Master DD (supporto archivist)   | Approved       | Report `reports/redirects/redirect-smoke-staging.json` **PASS** su host `http://localhost:8000` (log `[REDIR-SMOKE-2026-09-08T1200Z]`); gate attivazione sbloccato con allegato aggiornato e finestra QA 2025-12-01T09:00Z→2025-12-08T18:00Z verificata, fallback 2025-12-09 pronto.                                                                                                                                                                                                             |
...
| [#1206](https://github.com/MasterDD-L34D/Game/issues/1206) – Rollback redirect            | Master DD + dev-tooling | Blocked        | Baseline di rollback invariata (smoke `reports/redirects/redirect-smoke-staging.json` **PASS**, log `[REDIR-SMOKE-2026-09-08T1200Z]`), ma verifica 2025-12-05T11:08Z **FAIL** per archivi assenti (`redirect-config-2025-12-01.tar.gz` off-repo, zip 2025-11-29T0525Z mancanti). Ripristinare/ri-scaricare gli artifact e ripetere `sha256sum -c`/`tar -tzf` prima di riaprire il gate; finestra alternativa 2025-12-09T09:00Z→18:00Z resta disponibile. |
...
| Ok a finestra di attivazione | Master DD               | Approved       | Ticket Master DD [#1204](https://github.com/MasterDD-L34D/Game/issues/1204). Smoke test `reports/redirects/redirect-smoke-staging.json` **PASS** su host `http://localhost:8000` (log `[REDIR-SMOKE-2026-09-08T1200Z]`); gate di attivazione sbloccato con allegato su ticket e overlap QA 2025-12-01T09:00Z → 2025-12-08T18:00Z verificato, fallback 2025-12-09 valido.                                                                                                           |
...
| Rollback (se necessario)     | Master DD + Dev-tooling | Ready (archive-less) | Ticket Master DD [#1206](https://github.com/MasterDD-L34D/Game/issues/1206) da aggiornare: rollback basato su hash testuali (`config/data_path_redirects.json` e `docs/planning/REF_CORE_DERIVED_MATRIX.md`) e smoke `reports/redirects/redirect-smoke-staging.json`; tar/zip dismessi. Log `[BACKUP-VERIFY-2025-12-05T1200Z]` da citare nel ticket al posto di link a archivi. |
