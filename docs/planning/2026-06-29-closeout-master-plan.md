...
| ------ | ------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------ |
| ~~N1~~ | ~~**SPEC-J `LETHAL_MISSIONS_ENABLED` flip**~~           | ✅ **DONE + FLIPPED LIVE prod 2026-06-30** -- encounter L'Ultima Caccia #3107/#3112 -> N=40 -> flip (f859817d). Permadeath attivo, reversibile. ⚠️ **RI-SPENTO 2026-07-09** (owner prod flag-set ratify): `LETHAL_MISSIONS_ENABLED=false` until K-07 -> permadeath NON attiva in prod oggi. Il gate SPEC-J (build + N=40 + calibrazione) resta CHIUSO; residuo unico = sign-off playtest K-07. Fonte fresca = overlay GGv2 riga lethal-consent (GGv2 `54b4e60`, riconciliato dai flag reali di prod).                                                                                                                         | DONE         | M-L    |
