...
3. **Verificare l'anteprima nel Trait Editor standalone**: avviare `npm run dev` da `apps/trait-editor/`, collegare il datasource con `VITE_TRAIT_DATA_SOURCE=remote` e `VITE_TRAIT_DATA_URL=../data/traits/index.json`, quindi confermare che form e anteprime riflettano le modifiche appena introdotte.【F:apps/trait-editor/README.md†L12-L45】【F:docs/traits-manuale/06-standalone-trait-editor.md†L14-L41】
...
| Anteprima editor standalone | `npm run dev` (da `apps/trait-editor/`, con variabili `VITE_TRAIT_DATA_SOURCE`, `VITE_TRAIT_DATA_URL`)                          | Interfaccia AngularJS con sync remoto e fallback mock automatico.               | 【F:apps/trait-editor/README.md†L12-L45】【F:docs/traits-manuale/06-standalone-trait-editor.md†L14-L41】                                        |
