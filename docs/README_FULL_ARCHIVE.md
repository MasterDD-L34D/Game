...
- **Checkpoint RIAPERTURA-2026-01/02 (2026-01-02, nota 2026-02-12)** — aperti i checkpoint RIAPERTURA-2026-01/02 per i patchset 01A–03B con l'obiettivo di riattivare i flussi preparatori senza modifiche di scope. Riferimenti operativi in [`docs/planning/REF_PLANNING_RIPRESA_2026.md`](./archive/planning-reference/REF_PLANNING_RIPRESA_2026.md), [`docs/planning/TKT-03AB-FREEZE.md`](./archive/planning-reference/TKT-03AB-FREEZE.md) e nei log di tracciabilità [`logs/agent_activity.md`](../logs/agent_activity.md).
...
- **Tri-Sorgente (Roll + Personalità + Azioni)** — docs introduttive: [/docs/tri-sorgente/overview.md](./architecture/tri-sorgente/overview.md) • QA/KPI: [/docs/tri-sorgente/qa.md](./architecture/tri-sorgente/qa.md)
