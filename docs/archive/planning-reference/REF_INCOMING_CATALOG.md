---
title: REF_INCOMING_CATALOG – Catalogo incoming/backlog
doc_status: draft
...
| 2025-11-29 | 2025-12-07 | archivist (approvazione Master DD)              | Freeze documentale CHIUSA/PASS 2025-12-07T18:00Z (finestra 2025-11-29T09:00Z → 2025-12-07T18:00Z) su `incoming/**` e `docs/incoming/**`; `_holding` assente (nessun drop registrato); nuovi drop post-unfreeze richiedono nuova finestra freeze con log/ticket e riferimento all’attivazione. |

**Stato freeze (2025-11-29):** finestra documentale CHIUSA/PASS alle 2025-12-07T18:00Z con approvazione Master DD; nessun drop registrato in `incoming/_holding` (cartella assente). Ogni nuovo drop post-unfreeze richiede apertura di una nuova finestra freeze e logging in `logs/agent_activity.md` con ticket di riferimento.

#### Gap list 01A (chiusa, approvata da Master DD)

| Fonte                                                                             | Missing mapping                                        | Owner proposto                                            | Ticket/Note                                                                                                                                                                                                                                                                           |
| --------------------------------------------------------------------------------- | ------------------------------------------------------ | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `incoming/lavoro_da_classificare/*`                                               | Nessun mapping verso core/derived né owner di dominio. | archivist (Master DD, supporto trait-curator)             | Ticket **[TKT-01A-001]** – Outcome **INTEGRARE** (triage + mapping owner) **CHIUSO** con approvazione Master DD; note allineate ai README incoming/docs e consegna a 01B. Owner 01B nominato: archivist con handoff documentato verso species/trait-curator per matrice core/derived. |
...
**Aggiornamento readiness 2025-12-01T01:44Z:** riesame 01B/01C con approvazione Master DD: finestra freeze documentale 2025-11-29T09:00Z → 2025-12-07T18:00Z chiusa/PASS come baseline; owner e ticket confermati (**[TKT-01B-001]**, **[TKT-01B-002]**, **[TKT-01C-001]**, **[TKT-01C-002]**) in modalità report-only sui branch `patch/01B-core-derived-matrix` e `patch/01C-tooling-ci-catalog`; logging STRICT MODE attivo con riallineamento ai gate 01B/01C già registrato nel log centrale.

**Delta rebaseline (vs finestre 2026):** la finestra documentale RIAPERTURA-2026-01 è stata sostituita dalla finestra effettiva 2025-11-29 → 2025-12-07 (PASS); i branch 01B/01C restano in report-only senza attivare checkpoint 2026, e ogni riutilizzo di materiali deve riferirsi al nuovo baseline 2025 per evitare agganci ai checkpoint storici 2026.
