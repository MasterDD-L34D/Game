...
| --- | --- | --- | --- | --- | --- |
| [action-items.md](docs/process/action-items.md) | Action Items — Sintesi operativa | Sintesi quotidiana attività cross-team e follow-up PR giornalieri. | UI Systems · Progression Design · VFX/Lighting · QA Support | 2026-07-02 | `docs/process/action-items.md` |
...
| [milestones.md](docs/process/milestones.md) | Checklist Milestone | Stato avanzamento milestone telemetria/dataset/playtest. | N/D | 2026-07-02 | `docs/process/milestones.md` |
| [project-setup-todo.md](docs/process/project-setup-todo.md) | TODO Operativo — Avvio completo del progetto | Sequenza end-to-end per rendere operativo il progetto con note storiche. | Ops/ChatGPT · Release Ops · Marketing Ops · Lead Dev Tools | 2026-07-02 | `docs/process/project-setup-todo.md` |
...
| File | Titolo | Scopo | Owner attuale | Ultimo aggiornamento | Percorso |
| --- | --- | --- | --- | --- | --- |
| [roadmap_operativa.md](docs/planning/roadmap_operativa.md) | Roadmap Operativa | Procedura settimanale post-ottobre 2025 con milestone e follow-up. | N/D | 2026-04-19 | `docs/planning/roadmap_operativa.md` |

### Appendici di stato

| File | Titolo | Scopo | Owner attuale | Ultimo aggiornamento | Percorso |
| --- | --- | --- | --- | --- | --- |
| [A-CANVAS_ORIGINALE.txt](docs/appendici/A-CANVAS_ORIGINALE.txt) | Canvas A — Originale | Visione principale con note telemetria/Resonance Shards. | N/D | N/D | `docs/appendici/A-CANVAS_ORIGINALE.txt` |
| [C-CANVAS_NPG_BIOMI.txt](docs/appendici/C-CANVAS_NPG_BIOMI.txt) | Canvas C — NPG & Biomi | Canvas NPG reattivi, biomi e protocolli soccorso. | N/D | N/D | `docs/appendici/C-CANVAS_NPG_BIOMI.txt` |
| [D-CANVAS_ACCOPPIAMENTO.txt](docs/appendici/D-CANVAS_ACCOPPIAMENTO.txt) | Canvas D — Mating, Reclutamento & Nido | Canvas sistemi attrazione, nido e ereditarietà parti. | N/D | N/D | `docs/appendici/D-CANVAS_ACCOPPIAMENTO.txt` |
