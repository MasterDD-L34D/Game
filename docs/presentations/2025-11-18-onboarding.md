---
title: Onboarding Support/QA — 18 novembre 2025
...
- Pubblicare nel canale `#vc-docs` il link alla registrazione demo CLI e il log generato con `scripts/cli_smoke.sh --label pre-onboarding-2025-11-08` (`logs/cli/pre-onboarding-2025-11-08-YYYYMMDDTHHMMSSZ.log` + snapshot `logs/cli/pre-onboarding-2025-11-08.log`).
...
- Verificare che tutti i partecipanti abbiano eseguito `scripts/cli_smoke.sh --profile support --log-subdir qa/2025-11-18 --label qa-2025-11-18` e caricato gli output risultanti in `logs/cli/qa/2025-11-18/`.
