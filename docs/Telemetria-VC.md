...
- Temi Enneagram (Conquistatore, Coordinatore, Esploratore, Architetto, Stoico) si attivano quando gli indici superano soglie (es. `aggro>0.65 && risk>0.55`), offrendo prompt narrativi e suggerimenti di mutazioni/Nido.【F:data/core/telemetry.yaml†L58-L63】【F:docs/appendici/D-CANVAS_ACCOPPIAMENTO.txt†L1-L69】
...
- KPI monitorati: tasso conversione NPG, durata scontri per bioma, attivazioni Protocollo di soccorso, StressWave medio per squadra, coesione aggregata (Delta/Echo).【F:docs/appendici/C-CANVAS_NPG_BIOMI.txt†L83-L132】【F:logs/playtests/2025-11-05-vc/session-metrics.yaml†L1-L102】
