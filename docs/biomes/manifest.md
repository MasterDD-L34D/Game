...
| `caverna`                   | Caverna Risonante         | `caverna_risonante` | `data/core/biomes.yaml`, `docs/guide/examples/encounter_caverna.txt`                         | Ecosistemi sotterranei eco-sintonizzati.【F:data/core/biomes.yaml†L191-L225】【F:docs/guide/examples/encounter_caverna.txt†L1-L47】                                      |
...
| `palude`                    | Palude Tossica            | –                   | `data/core/biomes.yaml`, `docs/guide/examples/encounter_palude.txt`                          | Miasmi corrosivi e culti simbiotici.【F:data/core/biomes.yaml†L513-L544】【F:docs/guide/examples/encounter_palude.txt†L1-L47】                                           |
...
| `savana`                    | Savana Ionizzata          | `savanna`           | `data/core/biomes.yaml`, `docs/guide/examples/encounter_savana.txt`                          | Dune fotoniche e clan erranti.【F:data/core/biomes.yaml†L607-L640】【F:docs/guide/examples/encounter_savana.txt†L1-L47】                                                 |
...
- Esempi di encounter generati in `docs/guide/examples/`.【F:docs/guide/examples/encounter_savana.txt†L1-L47】【F:docs/guide/examples/encounter_caverna.txt†L1-L47】【F:docs/guide/examples/encounter_palude.txt†L1-L47】
