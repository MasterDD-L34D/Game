...
- [x] Creare esempi di encounter documentati per ciascun bioma.【F:data/core/biomes.yaml†L1-L13】 _Aggiornati file in `docs/guide/examples/encounter_\*.txt`con seed`demo` (2025-10-26).\_
