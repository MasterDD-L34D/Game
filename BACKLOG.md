...
- **Remaining dir-batch**: planning cluster DONE (batch-7 April + batch-8 May/undated); **NEXT = tutorials+appendici+frontend+research+arch (~48)**; poi resto (museum/superpowers/adr/process/core/... ~70). (Ricalcolare col report a inizio batch.)
