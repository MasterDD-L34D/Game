...
- **Remaining dir-batch**: planning DONE (B7+B8); research+arch+frontend+appendici+tutorials DONE (B9); **NEXT = resto (~70): adr+core+process+ops+pipelines+museum+traits+reports-residui+superpowers + coda**. (Ricalcolare col report a inizio batch.)
