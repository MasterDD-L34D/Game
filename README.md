...
- **Checkpoint RIAPERTURA-2026-01/02 (2026-01-02, nota 2026-02-12)** — aperti i checkpoint RIAPERTURA-2026-01/02 per i patchset 01A–03B con l'obiettivo di riattivare i flussi preparatori senza modifiche di scope. Riferimenti operativi in [`docs/planning/REF_PLANNING_RIPRESA_2026.md`](docs/planning/REF_PLANNING_RIPRESA_2026.md), [`docs/planning/TKT-03AB-FREEZE.md`](docs/planning/TKT-03AB-FREEZE.md) e nei log di tracciabilità [`logs/agent_activity.md`](logs/agent_activity.md).
