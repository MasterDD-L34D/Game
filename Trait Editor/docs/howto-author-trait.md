...
2. Recupera i riferimenti dal [template dati](../../docs/traits_template.md) e dai report correnti (`../../docs/reports/trait_fields_by_type.json`, `../../docs/reports/trait_texts.json`).
...
1. Genera il riepilogo dei campi e delle stringhe approvate:
   ...
   python tools/py/collect_trait_fields.py \
     --output ../../docs/reports/trait_fields_by_type.json \
     --glossary data/core/traits/glossary.json \
     --glossary-output ../../docs/reports/trait_texts.json
   ```
...
- [ ] `docs/reports/trait_fields_by_type.json` e `docs/reports/trait_texts.json` rigenerati (allega gli output o includi il comando nel log PR).
