...
Tabella di sintesi per `incoming/**`. Stati ammessi: **INTEGRATO**, **DA_INTEGRARE**, **LEGACY**, **STORICO**. Vedi catalogo completo in `docs/planning/REF_INCOMING_CATALOG.md`. Owner 01A (catalogo): Laura B.
...
| Script DevKit duplicati                           | `incoming/docs/*`                                                                                                  | STORICO      | Duplicati potenziali di `tools/`; candidati archive_cold dopo snapshot.         |
