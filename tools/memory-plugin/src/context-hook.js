...
const { getContainerTag, getRepoContainerTag, getProjectName } = require('./lib/container-tag');
...
async function main() {
  ...
  try {
    ...
    const repoContext = formatContext(repoResult, true, false, settings.maxProfileItems, false);
