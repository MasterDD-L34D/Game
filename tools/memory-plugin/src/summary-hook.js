const { LocalMemoryClient, PERSONAL_ENTITY_CONTEXT } = require('./lib/local-memory-client');
const { getContainerTag, getProjectName } = require('./lib/container-tag');
const { loadSettings, debugLog, getSignalConfig } = require('./lib/settings');
...
async function main() {
  ...
  try {
    ...
    await client.addMemory(formatted, containerTag, {
      type: 'session_turn',
      project: projectName,
