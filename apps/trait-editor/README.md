...
3. Lancia `npm run build` all'interno della cartella `apps/trait-editor/`.
4. Archivia il contenuto di `apps/trait-editor/dist/` come artefatto (`dist/index.html`, `dist/assets/**`).
