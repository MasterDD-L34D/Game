...
- Ricordati di aggiornare anche il capitolo principale del manuale (`docs/traits-manuale/06-standalone-trait-editor.md`) e il `apps/trait-editor/README.md` con il numero di versione o la data dell'ultima sincronizzazione.
