...
I JSON di fallback sono stati riorganizzati sotto `apps/dashboard/public/data/` per categoria:
...
- **Test locale della build** – Esegui `npm run build && npm run preview` all'interno di `apps/dashboard/` (il
