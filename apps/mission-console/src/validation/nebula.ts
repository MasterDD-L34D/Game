...
function toNumberArray(values: unknown): number[] {
  ...
  return values.map((value) => Number(value)).filter((value) => Number.isFinite(value)) as number[];
}
          ...
          .object({
            ...
            telemetry: z
              ...
              .transform((telemetry) => ({
                ...
                lastValidation:
                  typeof telemetry.lastValidation === 'string'
                    ? telemetry.lastValidation
                    : undefined,
                curatedBy:
                  typeof telemetry.curatedBy === 'string' ? telemetry.curatedBy : undefined,
              }))
              .optional(),
            traits: z
              .object({
